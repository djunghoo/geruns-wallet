						...
						<div class="navbar-menu collapse navbar-collapse navbar-backdrop" id="navbarMenu">
							...
							<div class="navbar-nav">
								<?php /*
									...
									<a class="mt-1 dropdown-item btn btn-outline-grey bgc-h-primary-l3 btn-h-light-primary btn-a-light-primary" href="page-profile.html">
									...
									<a class="dropdown-item btn btn-outline-grey bgc-h-secondary-l3 btn-h-light-secondary btn-a-light-secondary" href="page-login.html">
