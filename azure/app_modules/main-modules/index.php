							...
							<form id="frm-main" name="frm-main" class="mt-4 text-dark-m1">
								<div class="form-group row mt-2">
									...
									<div class="col-sm-8 pr-0 pr-sm-3">
										<input required type="text" id="menu_title" name="menu_title" class="frm form-control col-11 col-sm-8 col-md-6" placeholder="ระบุชื่อเมนู" />
									</div>
								</div>
								...
								<div class="form-group row mt-2">
									...
									<div class="col-sm-8 pr-0 pr-sm-3">
										<select class="frm form-control col-11 col-sm-8 col-md-6" id="menu_type" name="menu_type" data-placeholder="Click to Choose...">
											<option value=''>กรุณาเลือกประเภทเมนู</option>
											<?php $sql="select id,title from menu_type order by id";
								...
								<div class="form-group row mt-2">
									...
									<div class="col-sm-8 pr-0 pr-sm-3">
										<input required type="text" id="menu_url" name="menu_url" class="frm form-control col-11 col-sm-8 col-md-6 frm4" placeholder="ระบุชื่อที่แสดงบน url" />
									</div>
								</div>
								...
								<div class="form-group row mt-2">
									...
									<div class="col-sm-8 pr-0 pr-sm-3">
										<input required type="text" id="menu_icon" name="menu_icon" class="frm form-control col-11 col-sm-8 col-md-6 frm4" placeholder="ระบุชื่อ class icon" />
									</div>
								</div>
								...
								<div class="form-group row mt-2">
									...
									<div class="col-sm-8 pr-0 pr-sm-3">
										<input required type="text" id="menu_file" name="menu_file" class="frm form-control col-11 col-sm-8 col-md-6 frm4" placeholder="ระบุชื่อ Folder" />
									</div>
								</div>
								...
								<div class="radius-1 table-responsive" style="min-height:300px;">
									...
									<table id="simple-table" class="mb-0 table table-striped table-bordered  brc-secondary-l3 text-dark-m2 radius-1 overflow-hidden">
										<thead class="text-white-tp3 bgc-primary text-90 border-b-1 brc-transparent">
											<tr>
												<th class="text-center col-1 pr-0">
													ที่
												</th>
												...
												<th class="text-center col-2 pr-0">
													ชื่อแสดงบน url
												</th>
						...
						<div class="modal-body" data-ace-scroll='{"smooth": true}'>
							<div class="form-group row">
								...
								<div class="col-sm-12 pr-0 pr-sm-3">
									<input type="text" class="form-control sfrm" id="s_menu_title" name="s_menu_title" />
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 pr-0 pr-sm-3">
									<select class="form-control sfrm" id="s_menu_type" name="s_menu_type" data-placeholder="Click to Choose...">
										<option value="">กรุณาประเภทเมนู</option>
										<?php $sql="select id,title from menu_type where status='1' order by id ";
											$query=$conn->prepare($sql);
											$query->execute($param);
											while($data=$query->fetch(PDO::FETCH_ASSOC)){
												echo "<option value='$data[id]'>$data[title]</option>";
