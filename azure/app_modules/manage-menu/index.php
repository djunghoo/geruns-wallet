<div class="page-content container container-plus">
	...
	<div id="results"></div>	
	<!-- style="display:none;" -->
	<div class="row mt-4" id="div-main-form" >
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form id="frm-main" name="frm-main" class="mt-4 text-dark-m1">
						...
						<div class="form-group row mt-2">
							...
							<div class="col-sm-8 pr-0 pr-sm-3 tag-input-style" id="select2-parent">
								<select multiple id="menu_id" name="menu_id[]" class="select2 form-control col-11 col-sm-8 col-md-6" data-placeholder="เลือกเมนูหลัก">
									<option value=''>กรุณาเลือกเมนูหลัก</option>
									<?php $sql="select menu_id as id,menu_title as title from menu where status='1' order by rec_order";
						...
						<div class="form-group row mt-2">
							...
							<div class="col-sm-8 pr-0 pr-sm-3">
								<select multiple="multiple" name="menu2_id[]" id="menu2_id">
